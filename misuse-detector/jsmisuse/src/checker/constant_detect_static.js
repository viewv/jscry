...
// Reuse original cryptographic signature constants
const CRYPTO_SIGNATURES = {
    AES: {
        // Signature values of AES S-box
        SBOX_VALUES: [
            0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67, 0x2b, 0xfe, 0xd7, 0xab, 0x76,
            0xca, 0x82, 0xc9, 0x7d, 0xfa, 0x59, 0x47, 0xf0, 0xad, 0xd4, 0xa2, 0xaf, 0x9c, 0xa4, 0x72, 0xc0
        ],
        // Signature values of AES Inverse S-box
        INV_SBOX_VALUES: [
    ...
    DES: {
        // DES S-box signature values (more complete)
        SBOX1_VALUES: [14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7],
        // DES PC2 permutation table signature values
        PC2_VALUES: [14, 11, 17, 4, 27, 23, 25, 0, 13, 22, 7, 18, 5, 9, 16, 24],
        // DES S-box table signature sequence
    ...
    RSA: {
        // Common RSA public key exponents
        COMMON_E: [3, 17, 65537],
        // Fermat numbers
...
/**
 * Check if array contains the specified subsequence
 * @param {Array} array - The array to check
 * @param {Array} sequence - The subsequence to search for
...
/**
 * Check if the array contains a certain ratio of specified values
 * @param {Array} array - The array to check
 * @param {Array} targetValues - The array of target values
 * @param {number} threshold - Match threshold (between 0-1)
 * @returns {boolean}
 */
function containsValues(array, targetValues, threshold = 0.6) {
    ...
    // Convert target values to both signed and unsigned formats
...
function extractNumericArray(value) {
    if (Array.isArray(value)) {
        // Handle nested arrays, flatten to 1D array
...
/**
 * Detect cryptographic algorithm constants (static version)
