...
function extractConstantValueStatic(code) {
  ...
  //                   const extractResult = extractArrayValueStatically(decl.init);
  //                   if (extractResult.success) {
  //                     iifeConstants[decl.id.name] = {
  //                       value: extractResult.value,
  //                       source: "static-iife-internal",
  //                       originalCode: extractResult.originalCode,
  //                     };
  //                   }
  //                 }
  ...
  //               iifeConstants[arrayKey] = {
  //                 value: extractResult.value,
  //                 source: "static-iife-array",
  //                 originalCode: extractResult.originalCode,
  //               };
  //             }
  //           },
  ...
  //             originalCode: constData.originalCode,
  //           });
  //         }
  //       }
  //     },
  ...
  //                 VariableDeclaration(declPath) {
  //                     declPath.node.declarations.forEach((decl) => {
  //                         if (decl.id.type === "Identifier" && decl.init && decl.init.type === "ArrayExpression") {
  //                             const extractResult = extractArrayValueStatically(decl.init);
  //                             if (extractResult.success) {
  //                                 functionConstants[decl.id.name] = {
  //                                     value: extractResult.value,
  //                                     source: 'static-function-internal',
  //                                     originalCode: extractResult.originalCode
  //                                 };
  //                             }
  //                         }
  ...
  //                     const extractResult = extractArrayValueStatically(arrayPath.node);
  //                     if (extractResult.success) {
  //                         const arrayKey = `__function_array_${arrayPath.node.loc.start.line}_${arrayPath.node.loc.start.column}`;
  //                         functionConstants[arrayKey] = {
  //                             value: extractResult.value,
