...
function(e, t, r) {
        t.readUInt32BE = function(e, t) {
            ...
            i |= t >>> f + a & 1, i <<= 1, i |= e >>> f + a & 1;
            for (a = 4; a < 8; a++) for (f = 24; f >= 0; f -= 8) o <<= 1, o |= t >>> f + a & 1, 
            o <<= 1, o |= e >>> f + a & 1;
            r[n + 0] = i >>> 0, r[n + 1] = o >>> 0;
        ...
        t.substitute = function(e, t) {
            ...
            for (n = 0; n < 4; n++) r <<= 4, r |= a = i[256 + 64 * n + (o = t >>> 18 - 6 * n & 63)];
            return r >>> 0;
        };
...
// ==================== 元数据 ====================
// 此文件包含从 wx02343c1ee5ea2b8a 提取的 DES 算法实现
// 检测位置: 行 6189-6189
// 变量名: i
// 检测源: static
