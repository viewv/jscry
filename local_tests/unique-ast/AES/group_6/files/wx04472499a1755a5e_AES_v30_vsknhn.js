...
function() {
            ...
            var h, m, g, v = [ 0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54 ], y = [ [], [], [], [] ], b = t.AES = {
                ...
                _encryptblock: function(t, e) {
                    ...
                    for (n = 0; n < 4; n++) for (i = 0; i < 4; i++) y[n][i] ^= g[i][n];
                    for (var o = 1; o < m; o++) {
                ...
                _init: function(t) {
                    h = t.length / 4, m = h + 6, b._keyexpansion(t);
                },
                _keyexpansion: function(t) {
                    g = [];
                    for (var e = 0; e < h; e++) g[e] = [ t[4 * e], t[4 * e + 1], t[4 * e + 2], t[4 * e + 3] ];
                    for (e = h; e < b._blocksize * (m + 1); e++) {
                        ...
                        n[2] = r[n[2]], n[3] = r[n[3]]), g[e] = [ g[e - h][0] ^ n[0], g[e - h][1] ^ n[1], g[e - h][2] ^ n[2], g[e - h][3] ^ n[3] ];
                    }
                }
            };
        }
...
// ==================== 元数据 ====================
// 此文件包含从 wx04472499a1755a5e 提取的 AES 算法实现
// 检测位置: 行 4923-4923
// 变量名: r
// 检测源: static
