...
function() {
            ...
            for (h = 0; h < 256; h++) {
                ...
                var m = d[r[_] = g], y = d[m], b = d[y], w = 257 * d[_] ^ 16843008 * _;
                i[g] = w << 24 | w >>> 8, o[g] = w << 16 | w >>> 16, s[g] = w << 8 | w >>> 24, u[g] = w, 
                w = 16843009 * b ^ 65537 * y ^ 257 * m ^ 16843008 * g, c[_] = w << 24 | w >>> 8, 
                l[_] = w << 16 | w >>> 16, f[_] = w << 8 | w >>> 24, p[_] = w, g ? (g = m ^ d[d[d[b ^ m]]], 
                v ^= d[d[v]]) : g = v = 1;
            }
