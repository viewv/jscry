...
(global.webpackJsonp = global.webpackJsonp || []).push([["common/vendor"], {
    ...
    "083b": function (e, t, n) {
        ...
        var s = n("b101"), c = s.blankChar, u = n("2d6c"), l = wx.getSystemInfoSync(), f = l.screenWidth, d = l.system, p = function () {
            function e(t) {
            ...
            return i(e, [{
                ...
                value: function () {
                    ...
                    if (this.options.nodes.length && (e.type = "node"), this.attrs = {}, s.ignoreTags[e.name]) if (t) if ("source" == e.name) {
                        ...
                        if (n && r.src) if ("video" == n.name || "audio" == n.name) n.attrs.source.push(r.src); else {
                            var o, i = r.media;
                            "picture" != n.name || n.attrs.src || r.src.indexOf(".webp") && d.includes("iOS") || !(!i || i.includes("px") && (-1 != (o = i.indexOf("min-width")) && -1 != (o = i.indexOf(":", o + 8)) && f > parseInt(i.substr(o + 1)) || -1 != (o = i.indexOf("max-width")) && -1 != (o = i.indexOf(":", o + 8)) && f < parseInt(i.substr(o + 1)))) || (n.attrs.src = r.src);
                        }
                ...
                value: function (e) {
                    ...
                    for (var l = 0, d = u.length; l < d; l++) {
                        var p = u[l].split(":");
                        if (!(p.length < 2)) {
                            var h = p[0].trim().toLowerCase(), g = p.slice(1).join(":").trim();
                ...
                value: function (e) {
                    ...
                    if ("table" == e.name) {
                        var l = n.cellpadding, f = n.cellspacing, d = n.border;
                        e.c && (this.bubble(), l || (l = 2), f || (f = 2)), d && (n.style = "border:".concat(d, "px solid gray;").concat(n.style || "")),
                            f && (n.style = "border-spacing:".concat(f, "px;").concat(n.style || "")), (d || l) && function e(t) {
                                for (var n, r = 0; n = t[r]; r++) "th" == n.name || "td" == n.name ? (d && (n.attrs.style = "border:".concat(d, "px solid gray;").concat(n.attrs.style)),
                    ...
                    if (this.CssHandler.pop && this.CssHandler.pop(e), "div" == e.name && !Object.keys(n).length) {
                        var p = this.siblings();
                        !(e.children || []).length && this.lineWrap ? e.name = "br" : (e.children || []).length ? 1 == e.children.length && "div" == e.children[0].name && (p[p.length - 1] = e.children[0]) : p.pop();
                    }
                }
            }, {
                key: "bubble",
    ...
    "104f": function (e, t) {
        ...
        var k = {
            ...
            debug: !1
        }, C = [], D = {}, T = {}, E = new (function () {
            function e() {
                x(this, e), this.resetIt(), this.initData();
            }
            return O(e, [{
                key: "type",
                value: function (e) {
                ...
                key: "initData",
                value: function () {
                    T[k._REPORT._BASIC._PV_ID] = this.getId(k._IDTYPE._PV_ID), T[k._REPORT._BASIC._SDK_VERSION] = "1.1";
                    var e = wx.getSystemInfoSync();
                    T[k._REPORT._CLIENT._CLI_LANG] = e.language, T[k._REPORT._CLIENT._CLI_SCREEN_TYPE] = e.screenWidth * e.pixelRatio + "x" + e.screenHeight * e.pixelRatio,
                        T[k._REPORT._CLIENT._CLI_DPR] = e.pixelRatio;
                }
            }, {
                key: "resetIt",
                value: function () {
                ...
                value: function (e, t) {
                    var n = this;
                    return A.ignores.some(function (r) {
                        var o = n.type(r);
                ...
                value: function (e) {
                    ...
                    t[k._REPORT._BASIC._CLI_TIME] = new Date().getTime();
                    var n = t[k._REPORT._URL._URL];
                    if (!n || "currentUrl" == n) {
                        var r = this.getCurrentUrl();
                        t[k._REPORT._URL._URL] = r;
                ...
                value: function () {
                    ...
                    if (!e) return A.host + "/pages/error";
                    var t = A.host + "/" + e.route, n = Object.entries(e.options).map(function (e) {
            ...
            return O(e, [{
                key: "report",
                value: function (e) {
                    e[k._REPORT._BASIC._REPORT_TYPE] = this._type, E.sendReport(e);
                }
            }]), e;
        }(), j = function (e) {
            function t() {
                var e;
                return x(this, t), e = n.call(this), e._name = "性能监控模块", e._type = k._MODULE._TYPE.PERFORMANCE_MODULE,
                    e._key = k._MODULE._KEY.PERFORMANCE_MODULE, e;
            }
            l(t, P);
            var n = d(t);
            return O(t, [{
                ...
                value: function () {
                    ...
                    e > 0 && this.report(u({}, k._REPORT._PERFORMANCE._FINISH_TIME, e));
                }
            }]), t;
        }();
        C.push(j);
        var M = new (function () {
            ...
            return O(e, [{
                ...
                value: function () {
                    ...
                    }), t.ignores && Array.isArray(t.ignores) && (e = A.ignores).push.apply(e, n(t.ignores)),
                        this.set(t), this.install(), this;
                }
            }, {
                key: "set",
                value: function (e) {
                    for (var t = k._REPORT._BASIC, n = 0, r = Object.entries(e); n < r.length; n++) {
    ...
    "133a": function (e, t, n) {
        ...
        }(n("5011")), f = n("503f"), d = new (function () {
            function e() {
                o(this, e), this.init();
            }
            return s(e, [{
                ...
                value: function () {
                    ...
                    this.isProduction = -1 == r.indexOf("wxapp.dev.faisco.com.cn"), f.setOptions({
                        ...
                        url: n ? "https://datareport.webportal.top/js/report" : "https://datareport.fkw.com/js/report",
                        login_aid: t,
                        login_sid: 0
    ...
    "1c20": function (e, s, c) {
        c.r(s), function (e) {
            ...
            var f = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0 !== e ? e : "undefined" != typeof self ? self : {}, d = c(function (e) {
                !function (t) {
                    var n, r = {};
                    r.VERSION = "1.6.0";
            ...
            var b = function (e) {
            ...
            }(wx.getFileSystemManager().readFile), _ = wx.getAccountInfoSync(), w = wx.getSystemInfoSync(), S = _.appId, x = function () {
                function e() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    n(this, e), t.verbose && d.setLevel(d.INFO), d.debug("construct option ", t), this.config = Object.assign(h, t),
                ...
                return i(e, [{
                        ...
                        var e = t(regeneratorRuntime.mark(function e() {
                            ...
                            return regeneratorRuntime.wrap(function (e) {
                                for (; ;) switch (e.prev = e.next) {
                                    case 0:
                                        if (this._reset(), d.info("start generateIdentifier"), e.prev = 1, d.time("[Uploader] generateIdentifier"),
                                    ...
                                    case 10:
                                        d.timeEnd("[Uploader] generateIdentifier"), d.debug("generateIdentifier ", this.identifier),
                                            e.next = 17;
                                        break;
                                    ...
                                    case 17:
                                        if (d.info("generateIdentifier end"), !(this.config.testChunks && this.config.verifyUrl)) {
                                            e.next = 33;
                                            break;
                                        }
                                        return d.info("start verify uploaded chunks"), d.time("[Uploader] verifyRequest"),
                                            e.next = 21, v(this.verifyRequest());

                                    case 21:
                                        if (t = e.sent, n = o(t, 2), i = n[0], a = n[1], d.timeEnd("[Uploader] verifyRequest"),
                                            d.debug("verifyRequest", i, a), !i) {
                                            e.next = 27;
                                            break;
                                        }
                                    ...
                                    case 27:
                                        if (s = a.data, c = s.needUpload, u = s.uploadedChunks, d.info("verify uploaded chunks end"),
                                            !!c) {
                                            e.next = 30;
                                            break;
                                        }
                                    ...
                                    case 33:
                                        this.chunksNeedSend = this.chunksIndexNeedSend.length, this.sizeNeedSend = this.chunksNeedSend * this.chunkSize,
                                            ...
                                            d.info("start upload chunks"), d.time("[Uploader] uploadChunks"), this.isUploading = !0,
                                            this._upload();
                    ...
                    key: "handleFail",
                    value: function (e) {
                        this.isFail || (d.error("upload file fail: ", e), this.isFail = !0, this.cancel(),
                        ...
                        this.on("uploadDone", t(regeneratorRuntime.mark(function t() {
                            ...
                            return regeneratorRuntime.wrap(function (t) {
                                for (; ;) switch (t.prev = t.next) {
                                    case 0:
                                        return d.timeEnd("[Uploader] uploadChunks"), d.info("upload chunks end"), e.isUploading = !1,
                                            d.info("start merge reqeust"), d.time("[Uploader] mergeRequest"), t.next = 3, v(e.mergeRequest());

                                    case 3:
                                        n = t.sent, i = o(n, 2), a = i[0], s = i[1], d.timeEnd("[Uploader] mergeRequest"),
                                            d.info("merge reqeust end"), d.debug("mergeRequest", a, s), a ? e.handleFail({
                                                errCode: 20003,
                                                errrMsg: a.errMsg
                                            }) : (d.info("upload file success"), e.emit("success", r({
                                                errCode: 0
                    ...
                    value: function () {
                        var e = this;
                        d.info("** pause **"), this.isUploading = !1, Object.keys(this.uploadTasks).map(function (e) {
                            return 1 * e;
                        }).forEach(function (t) {
                    ...
                    key: "resume",
                    value: function () {
                        d.info("** resume **"), this.isUploading = !0, this._upload();
                    }
                }, {
                    key: "cancel",
                    value: function () {
                        d.info("** cancel **"), this.pause(), this._reset();
                    }
                }, {
                    key: "_reset",
                    value: function () {
                    ...
                    value: function () {
                        ...
                        d.debug("readFileChunk chunks: " + s + ", chunksIndexNeedRead", this.chunksIndexNeedRead);
                    ...
                    value: function () {
                        ...
                        if (this.isUploading && !this.isFail && this.chunksQueue.length && Object.keys(this.uploadTasks).length !== this.config.maxConcurrency) {
                            ...
                            if (this.uploadedChunks.includes(o)) this.uploadChunk(); else {
                                var a = this.config, s = a.uploadUrl, c = a.query, u = a.header, f = this.identifier, p = l(s, r({}, c, {
                                    identifier: f,
                                    index: o,
                                    chunkSize: i,
                                ...
                                d.debug("uploadChunk index: " + o + ", lenght " + i), d.time("[Uploader] uploadChunk index-" + o),
                                    this._requestAsync({
                                        url: p,
                                        data: n,
                                        header: r({}, u, {
                                        ...
                                        return e.chunksSend++, delete e.uploadTasks[o], e.updateUploadSize(i), d.debug("uploadChunk success chunksSend: " + e.chunksSend),
                                            d.timeEnd("[Uploader] uploadChunk index-" + o), e.readFileChunk(), e.uploadChunk(),
                                            e.chunksSend === e.chunksNeedSend && e.emit("uploadDone"), null;
                                    }).catch(function (t) {
                                        t.errMsg.includes("request:fail abort") ? d.info("chunk index-" + o + " will be aborted") : e.handleFail({
                                            errCode: 20002,
                                            errMsg: t.errMsg
                                        });
                                    });
                    ...
                    value: function () {
                        var e = t(regeneratorRuntime.mark(function e() {
                            var t, n, r, i, a, s, c, u, l, f, d, h, g, y, m, _;
                            return regeneratorRuntime.wrap(function (e) {
                                for (; ;) switch (e.prev = e.next) {
                                    case 0:
                                        t = this.tempFilePath, n = this.totalSize, r = this.chunkSize, i = n < this.config.maxMemory,
                                            a = i ? r : 10485760, s = Math.ceil(n / a), c = new p.ArrayBuffer(), u = 0;
                                    ...
                                    case 7:
                                        if (d = e.sent, h = o(d, 2), g = h[0], y = h[1], !g) {
                                            e.next = 13;
                                            break;
                                        }
                                    ...
                                    case 18:
                                        return this.chunksIndexNeedRead = [], _ = c.end(), e.abrupt("return", (c.destroy(),
                                            _));
    ...
    "47c8": function (e, t, n) {
        (function (e) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (!e) return "";
                "string" == typeof e && (e = e && e.replace(/-/g, "/"));
            ...
            var o = n("60e3"), i = n("cf45"), a = function (e) {
                ...
                REFRESH_SEARCHRESULT_SINGLE: "infoIssue_refresh_searchResult_single",
                DELETE_SEARCHRESULT: "infoIssue_delete_searchResult"
            };
            t.eventTypes = s;
            var c = {
                AUDITING: 0,
            ...
            methods: {
                ...
                banHandler: function () {
                    ...
                    console.log("ban--userInfo", n), r.then(function () {
                        var n = e.checkMemberPower(e.setting);
                ...
                checkMemberPower: function (e) {
                    var t = getApp().globalData, n = t.wxappInfo, r = t.userInfo, o = e, i = !1;
                    ...
                    if (r && r.authPhone) if (a = !0, void 0 == o.btype || 0 == o.btype) r.levelInfo.id < o.bml && (i = !0); else {
                        i = !0;
            ...
            var h = {
                ...
                return p(n, [{
                    ...
                    value: function (e, t, n, r, o) {
                        var i = this, a = this.config, s = a.login_aid, c = a.login_sid, u = a.cliId, l = n || s, f = r || c, d = o || u, p = this.config, h = p.url, g = p.eventCommProp;
                        if (this.config.canReport) {
                            ...
                            return this.request(h, _, function () {
    ...
    "543d": function (e, t, n) {
        ...
        function A(e, t) {
            Object.keys(t).forEach(function (n) {
                -1 !== $e.indexOf(n) && m(t[n]) && (e[n] = I(e[n], t[n]));
            });
        }
        function C(e, t) {
            e && t && Object.keys(t).forEach(function (n) {
                -1 !== $e.indexOf(n) && m(t[n]) && k(e[n], t[n]);
            });
        }
        function D(e) {
            return function (t) {
        ...
        function L(e, t, n) {
            ...
            return a && Object.keys(a).length ? Array.isArray(a.invoke) ? E(a.invoke, n).then(function (e) {
                return t.apply(void 0, [P(a, e)].concat(o));
            }) : t.apply(void 0, [P(a, n)].concat(o)) : t.apply(void 0, [n].concat(o));
        }
        function R(e) {
        ...
        function B(e, t) {
            return F(e) ? function () {
                ...
                return m(n.success) || m(n.fail) || m(n.complete) ? j(e, L.apply(void 0, [e, t, n].concat(o))) : j(e, U(new Promise(function (r, i) {
        ...
        function H(e, t) {
            ...
            if (_(t)) {
                var i = !0 === o ? t : {};
                for (var a in m(n) && (n = n(t, i) || {}), t) if (w(n, a)) {
                    var s = n[a];
                    m(s) && (s = s(t[a], t, i)), s ? b(s) ? i[s] = t[a] : _(s) && (i[s.name ? s.name : a] = s.value) : console.warn("微信小程序 ".concat(e, "暂不支持").concat(a));
        ...
        function z(e, t, n) {
            ...
            return m(Ze.returnValue) && (t = Ze.returnValue(e, t)), H(e, t, n, {}, r);
        }
        function K(e, t) {
            if (w(Ze, e)) {
                var n = Ze[e];
                return n ? function (t, r) {
                    var o = n;
                    m(n) && (o = n(t));
                    var i = [t = H(e, t, o.args, o.returnValue)];
                    void 0 !== r && i.push(r);
                    var a = wx[o.name || e].apply(wx, i);
                    return $(e) ? z(e, a, o.returnValue, R(e)) : a;
                } : function () {
        ...
        function Z(e, t) {
            if (!t) return !0;
            if (Pe.default.options && Array.isArray(Pe.default.options[e])) return !0;
        ...
        function pe(e, t) {
            ...
            return n.forEach(function (e) {
                "$event" === e ? "__set_model" !== i || o ? o && !a ? c.push(t.detail.__args__[0]) : c.push(t) : c.push(t.target.value) : Array.isArray(e) && "o" === e[0] ? c.push(de(e)) : "string" == typeof e && w(s, e) ? c.push(s[e]) : c.push(e);
            }), c;
        }
        function he(e, t) {
        ...
        function ye(e) {
            ...
            return r.forEach(function (n) {
                ...
                r = c ? r.slice(1) : r, a && he(o, r) && a.forEach(function (n) {
                    ...
                    if (r) {
                        var o = t.$vm;
                        if (o.$options.generic && (o = ge(o) || o), "$emit" === r) return void o.$emit.apply(o, pe(t.$vm, e, n[1], n[2], s, r));
                        var a = o[r];
        ...
        function ve(e, t) {
            ...
            e.$options.store && (Pe.default.prototype.$store = e.$options.store), Pe.default.prototype.mpHost = "mp-weixin",
                Pe.default.mixin({
        ...
        function ke(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = t.isPage, r = t.initRelation, a = i(te(Pe.default, e), 2), s = a[0], c = a[1], u = o({
                multipleSlots: !0,
                addGlobalClass: !0
            }, c.options || {});
            ...
            var l = {
                options: u,
                data: oe(c, Pe.default.prototype),
                behaviors: ae(c, be),
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.createApp = Oe, t.createComponent = Ee, t.createPage = Te, t.default = void 0;
        var Pe = function (e) {
            return e && e.__esModule ? e : {
                default: e
            };
        }(n("66fd")), je = Object.prototype.toString, Me = Object.prototype.hasOwnProperty, Le = /-(\w)/g, Re = x(function (e) {
            return e.replace(Le, function (e, t) {
                return t ? t.toUpperCase() : "";
            });
        }), $e = ["invoke", "success", "fail", "complete", "returnValue"], Ne = {}, Ue = {}, Fe = {
        ...
        var ze = 1e-4, Ke = 750, Xe = !1, Ge = 0, Ye = 0, Je = {
            promiseInterceptor: Fe
        }, Qe = Object.freeze({
            __proto__: null,
            upx2px: function (e, t) {
                if (0 === Ge && W(), 0 === (e = Number(e))) return 0;
                var n = e / Ke * (t || Ge);
                return n < 0 && (n = -n), 0 === (n = Math.floor(n + ze)) && (n = 1 !== Ye && Xe ? .5 : 1),
                    e < 0 ? -n : n;
            },
            addInterceptor: function (e, t) {
                "string" == typeof e && _(t) ? A(Ue[e] || (Ue[e] = {}), t) : _(e) && A(Ne, e);
            },
            removeInterceptor: function (e, t) {
                "string" == typeof e ? _(t) ? C(Ue[e], t) : delete Ue[e] : _(e) && C(Ne, e);
            },
            interceptors: Je
        }), Ze = {
            previewImage: {
        ...
        var ot = {
            ...
            var e;
            return function () {
                return e || (e = new Pe.default()), e;
            };
        }(), st = Object.freeze({
            __proto__: null,
            $on: function () {
                return G(at(), "$on", Array.prototype.slice.call(arguments));
            },
            $off: function () {
                return G(at(), "$off", Array.prototype.slice.call(arguments));
            },
            $once: function () {
                return G(at(), "$once", Array.prototype.slice.call(arguments));
            },
            $emit: function () {
                return G(at(), "$emit", Array.prototype.slice.call(arguments));
            }
        }), ct = Object.freeze({
            __proto__: null
        }), ut = Page, lt = Component, ft = /:/g, dt = x(function (e) {
        ...
        bt.push.apply(bt, pt), et.forEach(function (e) {
            Ze[e] = !1;
        ...
        "undefined" != typeof Proxy ? _t = new Proxy({}, {
            get: function (e, t) {
                return w(e, t) ? e[t] : Qe[t] ? Qe[t] : ct[t] ? B(t, ct[t]) : it[t] ? B(t, it[t]) : rt[t] ? B(t, rt[t]) : st[t] ? st[t] : w(wx, t) || w(Ze, t) ? B(t, K(t, wx[t])) : void 0;
            },
            set: function (e, t, n) {
                return e[t] = n, !0;
            }
            ...
            (w(wx, e) || w(Ze, e)) && (_t[e] = B(e, K(e, wx[e])));
        })), wx.createApp = Oe, wx.createPage = Te, wx.createComponent = Ee;
        var wt = _t;
        t.default = wt;
    },
    "5b60": function (e, t, n) {
    ...
    "60e3": function (e, t, n) {
        (function (e) {
            ...
            function g(t) {
                function n(e) {
                    console.log("--------------------"), console.log("request：".concat(i.url, "?cmd=").concat(i.data.cmd)),
                        console.log("data:".concat(JSON.stringify(i.data))), console.log("error：", e), console.log("--------------------");
                }
                var r = k.getExtConfig(), o = {
                    url: "",
                    data: {
                        aid: r.aid,
                        wxappId: r.wxappId,
                ...
                if ("[object String]" === A.call(t.url)) a = t.url; else if ("[object Object]" === A.call(t.url)) {
                    var s = t.url;
            ...
            function m() {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = getApp().globalData, r = getCurrentPages(), i = r[r.length - 1].route, a = 0;
                if (n.visitorId) e(); else var s = setInterval(function () {
                    ++a >= 10 && clearInterval(s), n.visitorId && (clearInterval(s), e());
                }, 500);
            }
            function b(e) {
                ...
                return n.openId ? (e.openId = n.openId, r.data.userInfo = JSON.stringify(e), t = y(r)) : t = D().then(function (t) {
                    if (t) return e.openId = n.openId, r.data.userInfo = JSON.stringify(e), y(r);
                }).catch(function (e) {
                    console.error(e);
                }), t.then(function (t) {
                    if (t) {
            ...
            function _(t, n) {
                m({
                    ...
                    fail: function (n) {
                        121 == n.status && -1 != n.message.indexOf("此key每日调用量已达到上限") ? _(t, !0) : (e.hideLoading(),
                            e.showModal({
                                title: "请求失败",
                                content: n.message,
                                showCancel: !1
            ...
            function w(t) {
                console.log("正在上传...");
                var n = k.getExtConfig(), r = (0, x.stringifyUrl)({
                ...
                return e.uploadFile({
                    ...
                    return "object" == s(o.data) ? o.data : JSON.parse(o.data);
                }).catch(function (t) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.initLogin = h, t.request = y, t.logDog = function (e, t) {
                var n = {};
                if ("object" === s(e)) {
                    if (!(n = e[S.fromTypes.WEIXIN])) return;
                ...
                var n = k.getExtConfig();
                if (!n.isOem) {
                    var r = {};
                    if ("object" === s(e)) {
                        if (!(r = e[S.fromTypes.WEIXIN])) return;
            ...
            }, t.getUserInfoByCode = v, t.reportVisitorBehavior = m, t.getPhoneNumber = function () {
                return y({
                    url: {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (k.getExtConfig(), t.colId) return y({
                    data: {
            ...
            }, t.addUserInfo = b, t.setUserInfo = function () {
                return y({
                    url: {
            ...
            }, t.getLocationFromBaidu = _, t.memberLogin = function () {
                return y({
                    url: {
            ...
            }, t.commonUpload = function (t) {
                var n = k.getExtConfig(), r = n.wxappAid, o = n.wxappId, i = t.chunkOption, a = t.option;
                return e.showLoading({
                    ...
                    var s = t.data;
                    return i && i.fileSize > s.chunkSize && I.default.isSupport() ? (console.log("正在进行分片上传..."),
                        y({
                            url: {
                                path: "wxAppAdvanceUpload.jsp"
                            },
                            ...
                            var a = {
                                tempFilePath: i.filePath,
                                totalSize: i.fileSize,
                                maxConcurrency: s.maxConcurrency,
                                chunkSize: s.chunkSize,
                                maxMemory: s.maxMemory,
                                maxChunkRetries: s.maxChunkRetries,
                                timeout: s.timeout,
                                uploadUrl: "".concat(n.wxappDomainUrl).concat(i.url),
                                mergeUrl: "".concat(n.wxappDomainUrl).concat(i.url, "?cmd=").concat(i.cmd, "&fileType=").concat(i.fileType, "&wxappAid=").concat(r, "&wxappId=").concat(o),
                            ...
                            return new Promise(function (t) {
                                var n = new I.default(a);
                                n.upload(), n.on("complete", function (n) {
                                    console.log("upload complete", n), e.hideLoading(), t(n);
                                }), n.on("progress", function (e) {
                                    console.log("上传速度：".concat((e.averageSpeed / 1048576).toFixed(2), " MB/s"));
                                });
                            });
                        })) : w(a);
                });
            }, t.getWXAppInfo = t.getUserInfoByOfficialApi = t.initUserInfo = void 0;
            var S = n("85b1"), x = n("72bf"), I = function (e) {
                return e && e.__esModule ? e : {
                    default: e
                };
            }(n("1c20")), O = n("1819"), k = n("ca00"), A = Object.prototype.toString, C = k.mergeSamePromiseFunc(function () {
            ...
            t.getUserInfoByOfficialApi = C;
            var D = k.mergeSamePromiseFunc(function () {
                return 1154 === getApp().globalData.scene ? Promise.resolve(!0) : h().then(function (e) {
                    if (e) return v(e);
                }).then(function (e) {
                    if (e) return e;
                }).catch(function (e) {
            ...
            t.initUserInfo = D;
            var T = k.mergeSamePromiseFunc(function () {
                var t = getApp().globalData;
                return y({
                    data: {
                        cmd: "getWXAppInfo"
    ...
    "66fd": function (e, t, n) {
        n.r(t), function (e) {
            ...
            function $(e, t) {
                var n;
                if (c(e) && !(e instanceof Jn)) return v(e, "__ob__") && e.__ob__ instanceof or ? n = e.__ob__ : rr && !Hn() && (Array.isArray(e) || u(e)) && Object.isExtensible(e) && !e._isVue && (n = new or(e)),
                    t && n && n.vmCount++, n;
            }
            function N(e, t, n, r, o) {
                ...
                if (!a || !1 !== a.configurable) {
                    ...
                    Object.defineProperty(e, t, {
                        ...
                        set: function (t) {
                            var r = s ? s.call(e) : n;
                            t === r || t !== t && r !== r || s && !c || (c ? c.call(e, t) : n = t, u = !o && $(t),
                                i.notify());
                        }
                    });
                }
            ...
            function W(e, t) {
                ...
                for (var n, r, o, i = Kn ? Reflect.ownKeys(t) : Object.keys(t), a = 0; a < i.length; a++) "__ob__" !== (n = i[a]) && (r = e[n],
                    o = t[n], v(e, n) ? r !== o && u(r) && u(o) && W(r, o) : U(e, n, o));
                return e;
            }
            function V(e, t, n) {
                return n ? function () {
            ...
            function K(e, t) {
                ...
                if (n) {
                    var r, o, i, a = {};
                    if (Array.isArray(n)) for (r = n.length; r--;) "string" == typeof (o = n[r]) && (i = xn(o),
                        a[i] = {
                            type: null
                        }); else if (u(n)) for (var s in n) o = n[s], a[i = xn(s)] = u(o) ? o : {
                            type: o
                        };
                    e.props = a;
                }
            ...
            function Y(e, t, n) {
                ...
                if ("function" == typeof t && (t = t.options), K(t, n), X(t, n), G(t), !t._base && (t.extends && (e = Y(e, t.extends, n)),
            ...
            function Q(e, t, n, r) {
                ...
                if (s > -1) if (i && !v(o, "default")) a = !1; else if ("" === a || a === kn(e)) {
            ...
            function ie(e, t, n) {
                if (Pn.errorHandler) try {
                    return Pn.errorHandler.call(null, e, t, n);
                } catch (t) {
            ...
            function ae(e, t, n) {
                if (!Rn && !$n || "undefined" == typeof console) throw e;
                console.error(e);
            }
            function se() {
                ur = !1;
            ...
            function pe(e, t, o, i) {
                ...
                if (r(c) || r(u)) for (var l in a) {
                    var f = kn(l);
                    (ge(o, u, l, f, !0) || ge(o, c, l, f, !1)) && o[l] && -1 !== s.indexOf(f) && i[xn(o[l])] && (o[l] = i[xn(o[l])]);
                }
                return o;
            }
            function he(e, t, o, i) {
            ...
            function ve(e) {
                return s(e) ? [P(e)] : Array.isArray(e) ? be(e) : void 0;
            }
            function me(e) {
            ...
            function be(e, t) {
                ...
                for (i = 0; i < e.length; i++) n(a = e[i]) || "boolean" == typeof a || (c = l.length - 1,
                    u = l[c], Array.isArray(a) ? a.length > 0 && (a = be(a, (t || "") + "_" + i), me(a[0]) && me(u) && (l[c] = P(u.text + a[0].text),
                        a.shift()), l.push.apply(l, a)) : s(a) ? me(u) ? l[c] = P(u.text + a) : "" !== a && l.push(P(a)) : me(a) && me(u) ? l[c] = P(u.text + a.text) : (o(e._isVList) && r(a.tag) && n(a.key) && r(t) && (a.key = "__vlist" + t + "_" + i + "__"),
                            l.push(a)));
                return l;
            }
            function _e(e) {
            ...
            function Oe(e, t, n) {
                ...
                if (e) {
                    ...
                    for (var s in r = {}, e) e[s] && "$" !== s[0] && (r[s] = ke(t, s, e[s]));
                } else r = {};
                for (var c in t) c in r || (r[c] = Ae(t, c));
                return e && Object.isExtensible(e) && (e._normalized = r), A(r, "$stable", i), A(r, "$key", a),
                    A(r, "$hasNormal", o), r;
            }
            function ke(e, t, n) {
                var r = function () {
            ...
            function Ce(e, t) {
                ...
                if (Array.isArray(e) || "string" == typeof e) for (n = new Array(e.length), o = 0,
                    i = e.length; o < i; o++) n[o] = t(e[o], o, o, o); else if ("number" == typeof e) for (n = new Array(e),
                        o = 0; o < e; o++) n[o] = t(o + 1, o, o, o); else if (c(e)) if (Kn && e[Symbol.iterator]) {
                            n = [];
            ...
            function De(e, t, n, r) {
                ...
                i ? (n = n || {}, r && (n = _(_({}, r), n)), o = i(n, this, n._i) || t) : o = this.$slots[e] || t;
                var a = n && n.slot;
            ...
            function Te(e) {
                return J(this.$options, "filters", e, !0) || Dn;
            }
            function Ee(e, t) {
                return Array.isArray(e) ? -1 === e.indexOf(t) : e !== t;
            }
            function Pe(e, t, n, r, o) {
                var i = Pn.keyCodes[t] || n;
                return o && r && !Pn.keyCodes[t] ? Ee(o, r) : i ? Ee(i, e) : r ? kn(r) !== t : void 0;
            }
            function je(e, t, n, r, o) {
                if (n && c(n)) {
                    ...
                    for (var a in n) !function (a) {
                        if ("class" === a || "style" === a || _n(a)) i = e; else {
                            var s = e.attrs && e.attrs.type;
                            i = r || Pn.mustUseProp(t, s, a) ? e.domProps || (e.domProps = {}) : e.attrs || (e.attrs = {});
                        }
                        var c = xn(a), u = kn(a);
            ...
            function Ue(e, t, n, r) {
                ...
                for (var o = 0; o < e.length; o++) {
                    var i = e[o];
                    Array.isArray(i) ? Ue(i, t, n) : i && (i.proxy && (i.fn.proxy = !0), t[i.key] = i.fn);
                }
                return r && (t.$key = r), t;
            }
            function Fe(e, t) {
            ...
            function We(e) {
                e._o = Le, e._n = h, e._s = p, e._l = Ce, e._t = De, e._q = x, e._i = I, e._m = Me,
                    e._f = Te, e._k = Pe, e._b = je, e._v = P, e._e = Zn, e._u = Ue, e._g = Ne, e._d = Fe,
                    e._p = Be;
            }
            function Ve(e, t, n, r, i) {
                ...
                this.data = e, this.props = t, this.children = n, this.parent = r, this.listeners = e.on || vn,
                    this.injections = Se(c.inject, r), this.slots = function () {
                        return s.$slots || Oe(e.scopedSlots, s.$slots = xe(n, r)), s.$slots;
            ...
            function qe(e, t, n, o, i) {
                ...
                if (r(c)) for (var u in c) s[u] = Q(u, c, t || vn); else r(n.attrs) && ze(s, n.attrs),
                    r(n.props) && ze(s, n.props);
                var l = new Ve(n, s, i, o, e), f = a.render.call(null, l._c, l);
                if (f instanceof Jn) return He(f, n, l.parent, a, l);
                if (Array.isArray(f)) {
                    for (var d = ve(f) || [], p = new Array(d.length), h = 0; h < d.length; h++) p[h] = He(d[h], n, l.parent, a, l);
                    return p;
                }
            }
            ...
            function Ke(e, t, i, a, s) {
                if (!n(e)) {
                    ...
                    if (c(e) && (e = u.extend(e)), "function" == typeof e) {
                        ...
                        t = t || {}, Ut(e), r(t.model) && Je(e.options, t);
                        var f = he(t, e, s, i);
            ...
            function Qe(e, t, n, r, i, a) {
                return (Array.isArray(n) || s(n)) && (i = r, r = n, n = void 0), o(a) && (i = _r),
                    Ze(e, t, n, r, i);
            }
            function Ze(e, t, n, o, i) {
                ...
                return Array.isArray(o) && "function" == typeof o[0] && (n = n || {}, n.scopedSlots = {
                    default: o[0]
                }, o.length = 0), i === _r ? o = ve(o) : i === br && (o = ye(o)), "string" == typeof t ? (s = e.$vnode && e.$vnode.ns || Pn.getTagNamespace(t),
                    a = Pn.isReservedTag(t) ? new Jn(Pn.parsePlatformTagName(t), n, o, void 0, void 0, e) : n && n.pre || !r(c = J(e.$options, "components", t)) ? new Jn(t, n, o, void 0, void 0, e) : Ke(c, n, e, o, t)) : a = Ke(t, n, e, o),
            ...
            function nt(e) {
                ...
                e.$slots = xe(t._renderChildren, r), e.$scopedSlots = vn, e._c = function (t, n, r, o) {
            ...
            function it(e, t) {
                ...
                if (i && !r(e.owners)) {
                    ...
                    return c(g) && (d(g) ? n(e.resolved) && g.then(p, h) : d(g.component) && (g.component.then(p, h),
            ...
            function dt(e, t, n) {
                yr = e, de(t, n || {}, ut, lt, ft, e), yr = void 0;
            }
            function pt(e) {
                var t = Sr;
            ...
            function gt(e, t, n, r, o) {
                ...
                e.$options._parentListeners = n, dt(e, n, h), c && (e.$slots = xe(o, r.context),
                    e.$forceUpdate());
            }
            function yt(e) {
            ...
            function _t() {
                Cr = xr.length = Ir.length = 0, Or = {}, kr = Ar = !1;
            }
            function wt() {
                var e, t;
                for (Dr(), Ar = !0, xr.sort(function (e, t) {
                    return e.id - t.id;
                }), Cr = 0; Cr < xr.length; Cr++) (e = xr[Cr]).before && e.before(), t = e.id, Or[t] = null,
                    e.run();
                var n = Ir.slice(), r = xr.slice();
                _t(), It(n), St(r), zn && Pn.devtools && zn.emit("flush");
            }
            function St(e) {
            ...
            function Ot(e) {
                ...
                if (null == Or[t]) {
                    if (Or[t] = !0, Ar) {
                        for (var n = xr.length - 1; n > Cr && xr[n].id > e.id;) n--;
                        xr.splice(n + 1, 0, e);
                    } else xr.push(e);
                    kr || (kr = !0, ce(wt));
                }
            ...
            function At(e) {
                e._watchers = [];
                var t = e.$options;
                t.props && Ct(e, t.props), t.methods && Lt(e, t.methods), t.data ? Dt(e) : $(e._data = {}, !0),
            ...
            function Et(e, t) {
                ...
                for (var o in t) {
                    ...
                    r || (n[o] = new Pr(e, a || S, S, Mr)), o in e || Pt(e, o, i);
                }
            }
            function Pt(e, t, n) {
                var r = !Hn();
                "function" == typeof n ? (jr.get = r ? jt(t) : Mt(n), jr.set = S) : (jr.get = n.get ? r && !1 !== n.cache ? jt(t) : Mt(n.get) : S,
                    jr.set = n.set || S), Object.defineProperty(e, t, jr);
            }
            function jt(e) {
                return function () {
            ...
            function Lt(e, t) {
                e.$options.props;
                for (var n in t) e[n] = "function" != typeof t[n] ? S : An(t[n], e);
            }
            function Rt(e, t) {
                for (var n in t) {
                    var r = t[n];
            ...
            function Ut(e) {
                ...
                if (e.super) {
                    ...
                    if (n !== e.superOptions) {
                        e.superOptions = n;
                        var r = Ft(e);
                        r && _(e.extendOptions, r), (t = e.options = Y(n, e.extendOptions)).name && (t.components[t.name] = e);
                    }
                }
                return t;
            }
            ...
            function qt(e) {
                ...
                e.extend = function (e) {
                    ...
                    return a.prototype = Object.create(n.prototype), a.prototype.constructor = a, a.cid = t++,
                        a.options = Y(n.options, e), a.super = n, a.options.props && Ht(a), a.options.computed && zt(a),
            ...
            function Ht(e) {
                ...
                for (var n in t) kt(e.prototype, "_props", n);
            }
            function zt(e) {
            ...
            function en(e, t, n, r) {
                if (e !== t) {
                    var o = nn(e), i = nn(t);
                    if (o == Ur) if (i != Ur || Object.keys(e).length < Object.keys(t).length) tn(r, n, e); else {
                        for (var a in e) !function (o) {
                            var i = e[o], a = t[o], s = nn(i), c = nn(a);
                            if (s != Nr && s != Ur) i != t[o] && tn(r, ("" == n ? "" : n + ".") + o, i); else if (s == Nr) c != Nr || i.length < a.length ? tn(r, ("" == n ? "" : n + ".") + o, i) : i.forEach(function (e, t) {
                                en(e, a[t], ("" == n ? "" : n + ".") + o + "[" + t + "]", r);
                            }); else if (s == Ur) if (c != Ur || Object.keys(i).length < Object.keys(a).length) tn(r, ("" == n ? "" : n + ".") + o, i); else for (var u in i) en(i[u], a[u], ("" == n ? "" : n + ".") + o + "." + u, r);
                        }(a);
            ...
            function ln(e, t) {
                return r(e) || r(t) ? fn(e, dn(t)) : "";
            }
            function fn(e, t) {
                return e ? t ? e + " " + t : e : t || "";
            }
            function dn(e) {
                return Array.isArray(e) ? pn(e) : c(e) ? hn(e) : "string" == typeof e ? e : "";
            }
            function pn(e) {
                for (var t, n = "", o = 0, i = e.length; o < i; o++) r(t = dn(e[o])) && "" !== t && (n && (n += " "),
                    n += t);
                return n;
            }
            function hn(e) {
            ...
            g("slot,component", !0);
            var bn, _n = g("key,ref,slot,slot-scope,is"), wn = Object.prototype.hasOwnProperty, Sn = /-(\w)/g, xn = m(function (e) {
                return e.replace(Sn, function (e, t) {
                    return t ? t.toUpperCase() : "";
                });
            }), In = m(function (e) {
                return e.charAt(0).toUpperCase() + e.slice(1);
            }), On = /\B([A-Z])/g, kn = m(function (e) {
                return e.replace(On, "-$1").toLowerCase();
            }), An = Function.prototype.bind ? function (e, t) {
                return e.bind(t);
            } : function (e, t) {
                function n(n) {
                ...
                return e;
            }, Tn = ["component", "directive", "filter"], En = ["beforeCreate", "created", "beforeMount", "mounted", "beforeUpdate", "updated", "beforeDestroy", "destroyed", "activated", "deactivated", "errorCaptured", "serverPrefetch"], Pn = {
                ...
                async: !0,
                _lifecycleHooks: En
            }, jn = /a-zA-Z\u00B7\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u037D\u037F-\u1FFF\u200C-\u200D\u203F-\u2040\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD/, Mn = new RegExp("[^" + jn.source + ".$_\\d]"), Ln = "__proto__" in {}, Rn = "undefined" != typeof window, $n = "undefined" != typeof WXEnvironment && !!WXEnvironment.platform, Nn = $n && WXEnvironment.platform.toLowerCase(), Un = Rn && window.navigator.userAgent.toLowerCase(), Fn = Un && /msie|trident/.test(Un), Bn = (Un && Un.indexOf("msie 9.0"),
                Un && Un.indexOf("edge/"), Un && Un.indexOf("android"), Un && /iphone|ipad|ipod|ios/.test(Un) || "ios" === Nn), Wn = (Un && /chrome\/\d+/.test(Un),
                    Un && /phantomjs/.test(Un), Un && Un.match(/firefox\/(\d+)/), {}.watch);
            if (Rn) try {
                var Vn = {};
            ...
            var qn, Hn = function () {
                return void 0 === bn && (bn = !Rn && !$n && void 0 !== e && e.process && "server" === e.process.env.VUE_ENV),
                    bn;
            }, zn = Rn && window.__VUE_DEVTOOLS_GLOBAL_HOOK__, Kn = "undefined" != typeof Symbol && D(Symbol) && "undefined" != typeof Reflect && D(Reflect.ownKeys);
            qn = "undefined" != typeof Set && D(Set) ? Set : function () {
                function e() {
            ...
            var nr = Object.getOwnPropertyNames(tr), rr = !0, or = function (e) {
                this.value = e, this.dep = new Yn(), this.vmCount = 0, A(e, "__ob__", this), Array.isArray(e) ? (Ln ? e.push !== e.__proto__.push ? R(e, tr, nr) : L(e, tr) : R(e, tr, nr),
            ...
            if ("undefined" != typeof Promise && D(Promise)) {
                ...
                ar = function () {
                    lr.then(se), Bn && setTimeout(S);
                };
            } else if (Fn || "undefined" == typeof MutationObserver || !D(MutationObserver) && "[object MutationObserverConstructor]" !== MutationObserver.toString()) ar = "undefined" != typeof setImmediate && D(setImmediate) ? function () {
                setImmediate(se);
            } : function () {
                setTimeout(se, 0);
            }; else {
                var fr = 1, dr = new MutationObserver(se), pr = document.createTextNode(String(fr));
                dr.observe(pr, {
                    characterData: !0
                }), ar = function () {
            ...
            var yr, vr = {
                init: function (e, t) {
                    if (e.componentInstance && !e.componentInstance._isDestroyed && e.data.keepAlive) {
                        var n = e;
                        vr.prepatch(n, n);
                    } else (e.componentInstance = Xe(e, Sr)).$mount(t ? e.elm : void 0, t);
                },
                ...
                insert: function (e) {
                    ...
                    n._isMounted || (bt(n, "onServiceCreated"), bt(n, "onServiceAttached"), n._isMounted = !0,
                        bt(n, "mounted")), e.data.keepAlive && (t._isMounted ? xt(n) : vt(n, !0));
                },
                destroy: function (e) {
                    var t = e.componentInstance;
                    t._isDestroyed || (e.data.keepAlive ? mt(t, !0) : t.$destroy());
                }
            }, mr = Object.keys(vr), br = 1, _r = 2, wr = null, Sr = null, xr = [], Ir = [], Or = {}, kr = !1, Ar = !1, Cr = 0, Dr = Date.now;
            if (Rn && !Fn) {
                var Tr = window.performance;
                Tr && "function" == typeof Tr.now && Dr() > document.createEvent("Event").timeStamp && (Dr = function () {
                    return Tr.now();
                });
            }
            var Er = 0, Pr = function (e, t, n, r, o) {
                this.vm = e, o && (e._watcher = this), e._watchers.push(this), r ? (this.deep = !!r.deep,
                    ...
                    "function" == typeof t ? this.getter = t : (this.getter = C(t), this.getter || (this.getter = S)),
            ...
            (function (e) {
                e.prototype._init = function (e) {
                    var t = this;
                    t._uid = Lr++, t._isVue = !0, e && e._isComponent ? Nt(t, e) : t.$options = Y(Ut(t.constructor), e || {}, t),
                        t._renderProxy = t, t._self = t, ht(t), ct(t), nt(t), bt(t, "beforeCreate"), !t._$fallback && we(t),
                        At(t), !t._$fallback && _e(t), !t._$fallback && bt(t, "created"), t.$options.el && t.$mount(t.$options.el);
                };
            })(Bt), function (e) {
                var t = {
                    get: function () {
            ...
            var Rr = [String, RegExp, Array], $r = {
                KeepAlive: {
                    ...
                    render: function () {
                        ...
                        if (n) {
                            var r = Xt(n), o = this, i = o.include, a = o.exclude;
            ...
            (function (e) {
                ...
                }), e.options._base = e, _(e.options.components, $r), Wt(e), Vt(e), qt(e), Kt(e);
            ...
            var Nr = "[object Array]", Ur = "[object Object]", Fr = m(function (e) {
                var t = {}, n = /;(?![^(]*\))/g, r = /:(.+)/;
            ...
            Bt.prototype.__patch__ = function (e, t) {
                ...
                }), e.prototype.__init_provide = _e, e.prototype.__init_injections = we, e.prototype.__call_hook = function (e, t) {
                    var n = this;
                    T();
    ...
    "6d0a": function (e, t, n) {
        (function (e) {
            ...
            var d = n("60e3"), p = n("cf45"), h = r(n("ca00")), g = r(n("7c15")), y = n("dcc5"), v = {
                data: function () {
                    return {
                        navigationBarTitle: "",
                        moduleInfoList: [],
                ...
                methods: {
                    initWXAppInfo: function () {
                        var e = this;
                        return (0, p.getWXAppInfo)().then(function (t) {
                            t && (e.wxappInfo = t, e.globalColor = t.globalColor, e.initSessionKey(), (0, p.setNavigationBarColor)(t.topSetting));
                        });
                    },
                    initSessionKey: function () {
                        var e = this.wxappInfo;
                        getApp().globalData, e.personalApp || (0, d.getSessionKey)().then(function (e) { });
                    },
                    initColModuleInfo: function (t) {
                        var n = this;
                        return (0, d.getColInfo)({
                            colId: t
                        }).then(function (t) {
                            if (t) {
                        ...
                        0 != i[0].length ? g.default.getDistance(e, i, function (e) {
                            for (var n = e || [], i = t.moduleInfoList, a = 0, s = 0; s < r.length; s++) {
                                ...
                                for (var l = 0; l < c.length; l++) for (var f = a; f < n.length; f++) {
                                    var d = c[l].setting;
                                    if (d && d.cs.ao && 0 != d.cs.lat && 0 != d.cs.lng) {
                                        d.cs.distance = n[f].distance, a = f + 1;
                                        break;
                                    }
                                }
                    ...
                    commonAuthPopupCancelHandler: p.commonAuthPopupCancelHandler,
                    commonAuthPopupCompleteHandler: p.commonAuthPopupCompleteHandler
                },
                onShareAppMessage: function (e) {
                    var t = getApp().globalData, n = t.wxappInfo, r = this.colId;
                    r && (0, d.reportVisitorBehavior)({
                        type: 24,
                        relationId: r
                    ...
                    var y = (0, p.beforeShareAppMessage)({
                        params: g
                    }), v = {
                        title: o,
                        imageUrl: i
                ...
                onPullDownRefresh: function () {
                    ...
                    t.hasCommonPopup = !0, this.reloadPage().finally(function () {
                        getApp().globalData.hasAutoPopup && (0, p.selectComponent)("#authPopup").then(function (e) {
                            e && e.init();
                ...
                onLoad: function (e) {
                    ...
                    if (e._cliid && (r._cliid = e._cliid), this.initWXAppInfo().then(function (t) {
                        ...
                        this.initColModuleInfo(t)) : (0, p.getWXAppInfo)(["tabBarCusColList"]).then(function (e) {
                        ...
                        -1 !== i.indexOf("cusCol") && (i = "pages/cusCol/cusCol"), (0, d.reportVisitorBehavior)({
                            pageUrl: i,
                            relationId: t
                        });
                    }
                    (0, p.selectComponent)("#newcomerPopup").then(function (e) {
                        e && e.init();
                    });
                },
                onShareTimeline: function (e) {
                    ...
                    var c = (0, p.beforeShareTimeline)({
                        params: s
                    });
                    if (n.shareTimeLine) {
                        var u = n.shareTimeLine, l = u.tt, f = u.tle, d = u.it, h = u.p;
                        l && f && (r = f), d && h && (a = h);
                    }
                ...
                onShow: function () {
                    ...
                    (0, p.getWXAppInfo)().then(function (t) {
                        if (t) {
                        ...
                        console.error(e);
                    }), this._logDog("7000090", this.colId ? 3 : 4), t.hasAutoPopup && (0, p.selectComponent)("#authPopup").then(function (e) {
                        e && e.init();
                    });
                },
                onReady: function () {
    ...
    "72bf": function (t, n, r) {
        ...
        function y(e, t) {
            ...
            var i = !0, u = !1, d = void 0;
            try {
                for (var p, h = e.split("&")[Symbol.iterator](); !(i = (p = h.next()).done); i = !0) {
                    var y = p.value, v = b(t.decode ? y.replace(/\+/g, " ") : y, "="), m = o(v, 2), _ = m[0], w = m[1];
                    w = void 0 === w ? null : ["comma", "separator"].includes(t.arrayFormat) ? w : l(w, t),
                        n(l(_, t), w, r);
                }
            } catch (e) {
                e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
            ...
            var S = !0, x = !1, I = void 0;
            try {
                for (var O, k = Object.keys(r)[Symbol.iterator](); !(S = (O = k.next()).done); S = !0) {
                    var A = O.value, C = r[A];
                    if ("object" === (void 0 === C ? "undefined" : a(C)) && null !== C) {
                        var D = !0, T = !1, E = void 0;
                        try {
                            for (var P, j = Object.keys(C)[Symbol.iterator](); !(D = (P = j.next()).done); D = !0) {
                                var M = P.value;
                                C[M] = g(C[M], t);
                            }
                        } catch (e) {
        ...
        var v = r("6453"), m = r("f234"), b = r("f32c"), _ = function (e) {
        ...
        n.extract = h, n.parse = y, n.stringify = function (e, t) {
            ...
            try {
                for (var l, f = Object.keys(e)[Symbol.iterator](); !(o = (l = f.next()).done); o = !0) {
                    var d = l.value;
                    (function (n) {
                        return t.skipNull && _(e[n]) || t.skipEmptyString && "" === e[n];
                    })(d) || (r[d] = e[d]);
                }
            } catch (e) {
                e = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(e);
            ...
            var p = Object.keys(r);
            return !1 !== t.sort && p.sort(t.sort), p.map(function (r) {
                var o = e[r];
            ...
            var r = d(e.url).split("?")[0] || "", o = n.extract(e.url), i = n.parse(o, {
                sort: !1
    ...
    "7c15": function (e, t, n) {
        (function (t) {
            ...
            var s = n("1819"), c = n("ca00"), u = s, l = {};
            l.getExtConfigData = function () {
                return c.promisify(wx.getExtConfig)().then(function (e) {
                    if ("getExtConfig: ok" == e.errMsg) return e.extConfig;
                }).catch(function (e) {
                    console.log("get extConfigData Erro -- " + e.errMsg);
                });
            }, l.issueRequest = function (e) {
                function t() {
                ...
                getApp().globalData;
                var n = getApp().globalData, r = Object.prototype.toString, o = c.promisify(wx.request);
                if (e && 0 != Object.keys(e).length && e.url) return (n.extConfigData && n.extConfigData.wxappAid ? o(t()) : l.getExtConfigData().then(function (e) {
            ...
            }, l.logVisitDog = function (e, t) {
                l.getExtConfigData().then(function (n) {
            ...
            }, l.getLocationFromBaidu = function (e, t) {
                l.reportVisitorBehavior({
                    type: 22
                    ...
                    fail: function (t) {
                        121 == t.status && -1 != t.message.indexOf("此key每日调用量已达到上限") && l.getLocationFromBaidu(e, !0);
                    },
                    complete: function (e) { }
                });
            }, l.getLocationByAddr = function (e, t, n) {
                new s({
                    key: c.getKey(n)
                }).geocoder({
                    address: t,
                    ...
                    fail: function (n) {
                        121 == n.status && -1 != n.message.indexOf("此key每日调用量已达到上限") && l.getLocationByAddr(e, t, !0),
                            e();
                    },
                    complete: function (e) { }
                });
            }, l.getLocation = function (e) {
                return new Promise(function (n, r) {
                    t.getLocation({
                        type: "gcj02",
                        success: function (t) {
            ...
            }, l.getAddrByLocation = function (e, t) {
                return new Promise(function (n, r) {
                    new u({
                        key: c.getMapKey()
                    }).reverseGeocoder({
            ...
            }, l.getLocationByAddrv2 = function (e, t) {
                return new Promise(function (n, r) {
                    new u({
                        key: c.getMapKey()
                    }).geocoder({
            ...
            }, l.reportVisitorBehavior = function () {
                function e() {
            ...
            }, l.getProvince = c.promiseMemorize(a("appAjax/city.jsp?cmd=getProvinceInfo", "GET", {
                Lcid: 2052
            })), l.getCities = c.promiseMemorize(a("appAjax/city.jsp?cmd=cityGetChildren", "GET", {
                Lcid: 2052,
                type: "cityOrCounty"
            })), l.getCounty = c.promiseMemorize(a("appAjax/city.jsp?cmd=cityGetChildren", "GET", {
                Lcid: 2052,
                type: "cityOrCounty"
            })), e.exports = l;
        }).call(this, n("543d").default);
        ...
        (function (e) {
            ...
            var d = ["0:00", "0:30", "1:00", "1:30", "2:00", "2:30", "3:00", "3:30", "4:00", "4:30", "5:00", "5:30", "6:00", "6:30", "7:00", "7:30", "8:00", "8:30", "9:00", "9:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30", "19:00", "19:30", "20:00", "20:30", "21:00", "21:30", "22:00", "22:30", "23:00", "23:30"], p = ["0:00", "0:15", "0:30", "0:45", "1:00", "1:15", "1:30", "1:45", "2:00", "2:15", "2:30", "2:45", "3:00", "3:15", "3:30", "3:45", "4:00", "4:15", "4:30", "4:45", "5:00", "5:15", "5:30", "5:45", "6:00", "6:15", "6:30", "6:45", "7:00", "7:15", "7:30", "7:45", "8:00", "8:15", "8:30", "8:45", "9:00", "9:15", "9:30", "9:45", "10:00", "10:15", "10:30", "10:45", "11:00", "11:15", "11:30", "11:45", "12:00", "12:15", "12:30", "12:45", "13:00", "13:15", "13:30", "13:45", "14:00", "14:15", "14:30", "14:45", "15:00", "15:15", "15:30", "15:45", "16:00", "16:15", "16:30", "16:45", "17:00", "17:15", "17:30", "17:45", "18:00", "18:15", "18:30", "18:45", "19:00", "19:15", "19:30", "19:45", "20:00", "20:15", "20:30", "20:45", "21:00", "21:15", "21:30", "21:45", "22:00", "22:15", "22:30", "22:45", "23:00", "23:15", "23:30", "23:45"], h = (l = {
                renderDays: function (e, t, n) {
                    ...
                    if (c < 5) for (var l = 1 * t + 1 > 12 ? 1 : 1 * t + 1, f = 1 * t + 1 > 12 ? 1 * e + 1 : e, d = 1; d < 5 - c; d++) o.push({
                        day: d,
                        choosed: !1,
                        disable: !1,
                        year: f,
                    ...
                    var p = [], g = (n ? [{
                        ...
                        return "".concat(e.year, "-").concat(e.month, "-").concat(e.day);
                    }), _ = ["日", "一", "二", "三", "四", "五", "六"], w = new Date(), S = i(w.getFullYear(), w.getMonth() + 1, w.getDate()).getTime();
                    this.timepicker.todayTimestamp = S, o.map(function (e) {
                        ...
                        r.config.openGrade && r.config.gradeDay && S + 864e5 * (r.config.gradeDay - 1) - o < 0 && !e.disable && (e.disable = !0),
                            p.push({
                                weeks: _[n],
                                choosed: e.choosed,
                                disable: e.disable,
                    ...
                    }), this.timepicker.lastFiveDaysList = p;
                },
                ...
                disableTimepickerDays: function (e) {
                    ...
                    var f = (t || []).allTimeList, d = "".concat(n[0].year, "-").concat(n[0].month, "-").concat(n[0].day);
                    this.config.disableAll && f.forEach(function (e) {
                        return e.forbidden = !0;
                    });
                    var p = this.config.enableDays, h = (void 0 === p ? [] : p).map(function (e) {
                        return "".concat(e.year, "-").concat(e.month, "-").concat(e.day);
                    });
                    -1 !== h.indexOf(d) && (f = c.call(this, f)), -1 !== l.indexOf(d) && f.forEach(function (e) {
                        return e.forbidden = !0;
                    });
                    ...
                    this.config.disableWeekend || 0 != g && 6 != g || (f = c.call(this, f)), this.config.openWeek && (-1 !== this.config.openWeek.indexOf(g) || -1 !== h.indexOf(y) ? f = c.call(this, f) : 0 !== this.config.openWeek.length && -1 !== this.config.openWeek.indexOf(g) || f.forEach(function (e) {
                        return e.forbidden = !0;
                    })), this.config.isFromForm && (f = c.call(this, f)), this.config.disableTimePoint && 0 == this.config.tiemOrDate && (f = u.call(this, f)),
                ...
                var d = this.config.initCalendarDay;
                if (d && "function" == typeof d) return this.config.initCalendarDay(n);
            }), n(l, "catchTouch", function () { }), n(l, "closeTimepicker", function (e) {
                h.setTimepickerStatus.call(this, !1);
                var t = this.config;
                t.closeTimepicker && "function" == typeof t.closeTimepicker && t.closeTimepicker(e);
            }), l);
    ...
    a422: function (e, t, n) {
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.globalEventTypes = t.iOSVirtualPayTypes = t.collectSupportTargetTypes = void 0;
        var r = {
            NEWS: 0,
            AUDIO: 1,
            VEDIO: 2,
        ...
        var i = {
            LOGIN_EVENT: "global_login_event"
        };
        t.globalEventTypes = i;
    },
    b101: function (e, t) {
        function n(e) {
    ...
    ca00: function (e, t, n) {
        (function (t) {
            ...
            i.extend = function e() {
                var t, n, o, a, s, l, f = arguments[0] || {}, d = 1, p = arguments.length, h = !1;
                for ("boolean" == typeof f && (h = f, f = arguments[1] || {}, d = 2), "object" === r(f) || i.isFun(f) || (f = {}); d < p; d++) if (null != (t = arguments[d])) for (n in "string" == typeof t && (t = t.split("")),
    ...
    cd02: function (e, t, n) {
        ...
        var s = function (e) {
            ...
            Object.assign(l, o), wx.request({
                ...
                fail: function (r) {
                    w("request err!count=".concat(n, ";res=").concat(JSON.stringify(r))), n > 2 ? t.fail && t.fail(r) : setTimeout(function () {
                        e(t, ++n);
                    }, 2e3 * (n + 1));
                },
                complete: function (r) {
                    var o = r.statusCode;
                    if (o && 200 != o) return w("request statusCode err!count=".concat(n, ";statusCode=").concat(o)),
        ...
        e.exports = {
            ...
            getUnionId: function (e, t) {
                return "" == wx.getStorageSync("_SESSION_KEY_MD5") || null == wx.getStorageSync("_SESSION_KEY_MD5") || "undefined" == wx.getStorageSync("_SESSION_KEY_MD5") ? d().then(function (n) {
                    return h(e, t);
                }).catch(function (e) {
                    w(e);
                }) : h(e, t);
    ...
    cf45: function (e, t, n) {
        (function (e) {
            ...
            function p(e, t) {
                ...
                if (r) {
                    var o, i = getCurrentPages(), a = i[i.length - 1], s = 0, c = 0;
                    s = setInterval(function () {
                        if ((o = a.selectComponent("#authPopup")) || c > 3) {
                            if (clearInterval(s), !o) return void (e && "function" == typeof e && e(t));
                            t.baseAuth && (n.baseAuthInfo[r] = {
                                authType: t.baseAuth.type,
                                checked: !0
                            }), t.phoneAuth && (n.phoneAuthInfo[r] = t.phoneAuth), o.$vm._popupTemp = {
                                params: t,
                                next: e
                            }, o.$vm.show(r);
                        } else c++;
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                if (!t && n.openId) {
                    if (1 == e.getStorageSync("promoterType")) {
                        ...
                        console.log("globalData.openId"), console.log("绑定客户", r, "当前用户id", n.openId), n.openId != r && (0,
                            v.request)({
                                url: {
                ...
                return (0, v.initUserInfo)().then(function (t) {
                    if (t) {
                        if (1 == e.getStorageSync("promoterType")) {
                            var r = e.getStorageSync("openId");
                            console.log("res.openId"), console.log("绑定客户", r, "当前用户id", t.openId), t.openId != r && (0,
                                v.request)({
                                    url: {
                                        path: "appAjax/promoter.jsp"
                                    },
                ...
                return e.getSetting().then(function (e) {
                    ...
                    if (void 0 !== e) return console.log("isUserInfoEmpty", S.isUserInfoEmpty()), e && !S.isUserInfoEmpty() ? getApp().globalData.userInfo : (0,
            ...
            }, t.navigateTo = h, t.commonMakePhoneCall = d, t.commonAuthPopupShowHandler = p,
                t.commonAuthPopupCancelHandler = function (t) {
                    ...
                    y(!1), g(!1), S.getCurrentPageEventBus().$emit(b.SHOW_SHADOWVIEW);
                    var t = e.detail || e;
                    if (t && t.setting) {
                    ...
                    y(!0), g(!0), S.getCurrentPageEventBus().$emit(b.HIDE_SHADOWVIEW);
                    ...
                    if (t) {
                        ...
                        switch (o) {
                            ...
                            case 10:
                                var p;
                                p = t.extraData || {}, e.navigateToMiniProgram({
                                    appId: t.appid,
                                    path: t.page,
                                    envVersion: "release",
                                    extraData: p,
                            ...
                            case 20:
                                e.setClipboardData({
                                    ...
                                    success: function () {
                                        e.showToast({
                                            title: "复制成功"
                                        }), (0, v.logDog)(i({}, _.fromTypes.WEIXIN, {
                                            dogId: 7000259,
                                            srcId: 1
                                        }));
                                    }
                    ...
                    if (r) {
                        if (i) {
                            ...
                            if (!I[i]) {
                                ...
                                e.openId && (s.openId = !0), I[i] = (0, v.request)(s).then(function (t) {
                                    if (t && t.success) {
            ...
            }(n("477c")), b = n("dcc5"), _ = n("85b1"), w = n("72bf"), S = n("ca00"), x = {}, I = {};
        }).call(this, n("543d").default);
    },
    dcc5: function (e, t, n) {
        Object.defineProperty(t, "__esModule", {
    ...
    f1db: function (e, t, n) {
        ...
        function c(e) {
            ...
            var d = o(e.year, e.month, e.day).getDay();
            if (0 != d && 6 != d || (t = !!this.config.disableWeekend, f - n < 0 && this.config.isDisableWeekendInPastDay && (t = !0)),
                f - n < 0 && this.config.disablePastDay && (t = !!this.config.disablePastDay), -1 !== c.indexOf(l) && (t = !0),
                this.config.openWeek && -1 == this.config.openWeek.indexOf(d) && (t = !0), -1 !== u.indexOf(l) && (t = !1),
                ...
                var p = this.config.disableTimePoint.d, h = e.year, g = e.month, y = e.day;
        ...
        var d = {
            ...
            renderCalendar: function (e, t, n) {
                d.calculateEmptyGrids.call(this, e, t), d.calculateDays.call(this, e, t, n);
                var r = (this.calendar || {}).todoLabels, o = this.config.afterCalendarRender;
                r && r instanceof Array && d.setTodoLabels.call(this), o && "function" == typeof o && !this.firstRender && (o(),
                    this.firstRender = !0);
            },
            calculateEmptyGrids: function (e, t) {
                d.calculatePrevMonthGrids.call(this, e, t), d.calculateNextMonthGrids.call(this, e, t);
            },
            calculatePrevMonthGrids: function (e, t) {
                for (var n = [], r = d.getThisMonthDays(e, t - 1), o = r - d.getFirstDayOfWeek(e, t), i = r; i > o; i--) n.push(i);
                this.calendar.empytGrids = n.reverse();
            },
            calculateNextMonthGrids: function (e, t) {
                var n = [], r = d.getThisMonthDays(e, t), i = o(e, t, r).getDay(), a = 42 - this.calendar.empytGrids.length - r, s = 7 - (i + 1);
                a > s && (s = a);
                for (var c = 1; c <= s; c++) n.push(c);
                this.calendar.lastEmptyGrids = n;
            },
            calculateDays: function (e, t, n) {
                for (var r = this, i = [], a = this.calendar, s = a.todayTimestamp, u = d.getThisMonthDays(e, t), l = n ? [{
                    day: n,
                    choosed: !0,
                    year: e,
                    month: t
                ...
                var p = this.config.disableDays, h = void 0 === p ? [] : p, g = this.config.enableDays, y = void 0 === g ? [] : g, v = (h.map(function (e) {
                    return "".concat(e.year, "-").concat(e.month, "-").concat(e.day);
                }), y.map(function (e) {
                    return "".concat(e.year, "-").concat(e.month, "-").concat(e.day);
                }), l.map(function (e) {
            ...
            choosePrevMonth: function () {
                ...
                r < 1 && (n = t - 1, r = 12), n < 1920 || (d.renderCalendar.call(this, n, r), e.curYear = n,
                    e.curMonth = r);
            },
            chooseNextMonth: function () {
                var e = this.calendar, t = e.curYear, n = e.curMonth + 1, r = t;
                n > 12 && (r = t + 1, n = 1), r > 2050 || (d.renderCalendar.call(this, r, n), e.curYear = r,
                    e.curMonth = n);
            },
            chooseMonth: function (e) {
                var t = e.detail.value.split("-"), n = 1 * t[0], r = 1 * t[1];
                d.renderCalendar.call(this, n, r), this.calendar.curYear = n, this.calendar.curMonth = r;
            },
            closeCalendar: function (e) {
                d.setCalendarStatus.call(this, !1);
            ...
            tapDayItem: function (e) {
                ...
                if (!t.disable) {
                    ...
                    c ? d.whenMulitSelect.call(this, u) : d.whenSingleSelect.call(this, u);
                }
            },
            comfirmDay: function (e) {
                var t = {}, n = this.config, r = (n.multi, n.comfirmDay);
                if (!(t = this.calendar.selectedDay[0]).disable) return d.setCalendarStatus.call(this, !1),
            ...
            whenMulitSelect: function () {
                ...
                this.calendar.days = r, this.calendar.selectedDay = n, d.afterTapDay.call(this, t, n);
            },
            whenSingleSelect: function () {
                var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = t.currentSelected, r = t.selectedDays, o = [], i = t.days, a = t.idx, s = t.onTapDay, c = t.e, u = r[0], l = u.month, f = u.year, p = i[0], h = p.month, g = p.year, y = this.calendar;
                ...
                y.days = i, y.selectedDay = [n], d.afterTapDay.call(this, n);
            },
            setTodoLabels: function () {
                ...
                var r = n.days.slice(), o = n.curYear, i = n.curMonth, a = t.days, c = void 0 === a ? [] : a, u = t.pos, l = void 0 === u ? "bottom" : u, f = t.dotColor, d = void 0 === f ? "" : f, p = n.todoLabels, h = void 0 === p ? [] : p, g = n.todoLabelPos, y = n.todoLabelColor, v = c.filter(function (e) {
            ...
            deleteTodoLabels: function (e) {
                if (e instanceof Array && e.length) {
                    var t = d.filterTodos.call(this, e), n = this.calendar, r = n.days, o = n.curYear, i = n.curMonth, a = t.filter(function (e) {
            ...
            jumpToToday: function () {
                ...
                a.curYear = t, a.curMonth = n, a.selectedDay = [{
                    ...
                    year: t,
                    month: n
                }], a.todayTimestamp = i, d.renderCalendar.call(this, t, n, r);
            },
            ...
            calendarTouchmove: function (e) {
                if (i.call(this, e)) {
                    if (this.weekMode) return d.calculateNextWeekDays.call(this);
                    d.chooseNextMonth.call(this);
                }
                if (a.call(this, e)) {
                    if (this.weekMode) return d.calculatePrevWeekDays.call(this);
                    d.choosePrevMonth.call(this);
                }
            },
            updateCurrYearAndMonth: function (e) {
                var t = this.calendar, n = t.days, r = t.curYear, o = t.curMonth, i = r, a = o, s = n[0], c = s.month, u = s.year, l = n[n.length - 1], f = l.month, p = l.year;
                c !== f && ("prev" === e ? (r = u, a = c) : (r = p, a = f));
                var h = d.getThisMonthDays(r, o), g = n[n.length - 1], y = n[0];
            ...
            calculateLastDay: function () {
                ...
                return {
                    ...
                    lastDayInThisMonth: d.getThisMonthDays(n, r)
                };
            },
            ...
            firstWeekInMonth: function (e, t) {
                var n = [1, 6 - d.getDayOfWeek(e, t, 1) + 1];
                return this.calendar.days.slice(n[0] - 1, n[1]);
            },
            lastWeekInMonth: function (e, t) {
                var n = d.getThisMonthDays(e, t), r = [n - d.getDayOfWeek(e, t, n), n];
            ...
            calculateNextWeekDays: function () {
                var e = d.calculateLastDay.call(this), t = e.lastDayInThisWeek, n = e.lastDayInThisMonth, r = this.calendar, o = r.curYear, i = r.curMonth, a = [];
                if (n - t >= 7) {
                    var s = d.updateCurrYearAndMonth.call(this, "next");
                    ...
                    var l = d.updateCurrYearAndMonth.call(this, "next");
                ...
                a = d.initSelectedDay.call(this, a), this.calendar.curYear = o, this.calendar.curMonth = i,
                    this.calendar.days = a;
            },
            calculatePrevWeekDays: function () {
                var e = this.calendar, t = d.calculateFirstDay.call(this).firstDayInThisWeek, n = e.curYear, r = e.curMonth, o = [];
                if (t - 7 > 0) {
                    var i = d.updateCurrYearAndMonth.call(this, "prev");
                    ...
                    var u = d.updateCurrYearAndMonth.call(this, "prev");
                    n = u.Uyear, r = u.Umonth;
                    for (var l = d.getThisMonthDays(n, r), f = l - Math.abs(t - 7); f <= l; f++) o.push({
                        year: n,
                        month: r,
                        day: f
                    });
                ...
                o = d.initSelectedDay.call(this, o), e.curYear = n, e.curMonth = r, e.days = o;
            },
            selectedDayWeekAllDays: function (e) {
                var t = this.calendar, n = this.calendar, r = n.days, o = n.curYear, i = n.curMonth, a = e.year, s = e.month, c = e.day, u = d.lastWeekInMonth.call(this, a, s), l = [], f = [], p = d.firstWeekInMonth.call(this, a, s);
                if (o === a && i === s || (c = 1), o !== a && (a = o), i !== s && (s = i), p.find(function (e) {
                    return e.day === c;
                })) {
                    var h = [], g = d.getThisMonthDays(a, s - 1), y = d.updateCurrYearAndMonth.call(this, "prev");
                    o = y.Uyear, i = y.Umonth;
                    for (var v = g - (7 - p.length) + 1; v <= g; v++) h.push({
                        year: o,
                        month: i,
                        day: v
                    });
                    ...
                    var m = [];
                    if (u && u.length < 7) {
                        var b = d.updateCurrYearAndMonth.call(this, "next");
                        o = b.Uyear, i = b.Umonth;
                        for (var _ = 1, w = 7 - u.length; _ <= w; _++) m.push({
                            year: o,
                            month: i,
                            day: _
                        });
                    ...
                    var S = d.getDayOfWeek(a, s, c), x = [c - S, c + (6 - S)];
                    r = r.slice(x[0] - 1, x[1]);
                }
                r = d.initSelectedDay.call(this, r), t.days = r, t.empytGrids = l, t.lastEmptyGrids = f;
            },
            switchWeek: function (e) {
                ...
                if (r.length) {
                    ...
                    if ("week" === e) {
                        ...
                        this.weekMode = !0, d.selectedDayWeekAllDays.call(this, a);
                    } else {
                        this.weekMode = !1;
                        var s = a.year, c = a.month, u = a.day;
                        o === s && i === c || (u = 1), d.renderCalendar.call(this, o, i, u);
                    }
                }
            },
        ...
        var p = function (e, t, n) {
            ...
            if (!c || +c[0].year != +e || +c[0].month != +t || +c[0].day != +n) return e && t ? "number" != typeof +e || "number" != typeof +t ? console.error("jump 函数年月日参数必须为数字") : (s.curYear = e,
                s.curMonth = t, void r.$nextTick(function () {
                    if ("number" == typeof +n) return d.renderCalendar.call(r, e, t, n);
                    d.renderCalendar.call(r, e, t);
                })) : void d.jumpToToday.call(r);
        };
        t.jump = p;
        t.setTodoLabels = function (e) {
            var t = u();
            d.setTodoLabels.call(t, e);
        };
        t.deleteTodoLabels = function (e) {
            var t = u();
            d.deleteTodoLabels.call(t, e);
        };
        t.clearTodoLabels = function () {
            var e = u();
            d.clearTodoLabels.call(e);
        };
        t.switchView = function (e) {
            var t = u();
            d.switchWeek.call(t, e);
        };
        t.disableDay = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = u();
            d.disableDays.call(t, e);
        };
        t.enableDay = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = u();
            d.enableDays.call(t, e);
        };
        t.default = function () {
            ...
            var o = u();
            o.config = e, d.setCalendarStatus.call(o, !0);
