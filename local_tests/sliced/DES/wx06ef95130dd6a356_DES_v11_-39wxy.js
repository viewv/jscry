...
function(t, e, r) {
        ...
        e.readUInt32BE = function(t, e) {
            ...
            for (var i = 0, o = 0, a = 0; a < 4; a++) for (var f = 24; f >= 0; f -= 8) i <<= 1, 
            i |= e >>> f + a & 1, i <<= 1, i |= t >>> f + a & 1;
            for (a = 4; a < 8; a++) for (f = 24; f >= 0; f -= 8) o <<= 1, o |= e >>> f + a & 1, 
            o <<= 1, o |= t >>> f + a & 1;
            r[n + 0] = i >>> 0, r[n + 1] = o >>> 0;
        ...
        e.pc2 = function(t, e, r, i) {
            for (var o = 0, a = 0, f = n.length >>> 1, s = 0; s < f; s++) o <<= 1, o |= t >>> n[s] & 1;
...
// ==================== 元数据 ====================
// 此文件包含从 wx06ef95130dd6a356 提取的 DES 算法实现
// 检测位置: 行 8997-8997
// 变量名: n
// 检测源: static
