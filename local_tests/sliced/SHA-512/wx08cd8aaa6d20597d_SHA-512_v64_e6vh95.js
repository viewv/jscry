...
function(t, e, n) {
        ...
        r(c, o), c.prototype.init = function() {
            ...
            for (var e = this._w, n = 0 | this._a, r = 0 | this._b, o = 0 | this._c, i = 0 | this._d, s = 0 | this._e, c = 0 | this._f, g = 0 | this._g, m = 0 | this._h, y = 0; y < 16; ++y) e[y] = t.readInt32BE(4 * y);
            for (;y < 64; ++y) e[y] = p(e[y - 2]) + e[y - 7] + l(e[y - 15]) + e[y - 16] | 0;
            for (var v = 0; v < 64; ++v) {
                var b = m + h(s) + u(s, c, g) + a[v] + e[v] | 0, I = d(n) + f(n, r, o) | 0;
                m = g, g = c, c = s, s = i + b | 0, i = o, o = r, r = n, n = b + I | 0;
            }
            this._a = n + this._a | 0, this._b = r + this._b | 0, this._c = o + this._c | 0, 
            this._d = i + this._d | 0, this._e = s + this._e | 0, this._f = c + this._f | 0, 
            this._g = g + this._g | 0, this._h = m + this._h | 0;
