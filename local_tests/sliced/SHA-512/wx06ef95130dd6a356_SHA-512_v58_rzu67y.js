...
function(t, e, r) {
        ...
        n(s, i), s.prototype.init = function() {
            ...
            for (var e = this._w, r = 0 | this._a, n = 0 | this._b, i = 0 | this._c, o = 0 | this._d, f = 0 | this._e, s = 0 | this._f, b = 0 | this._g, v = 0 | this._h, y = 0; y < 16; ++y) e[y] = t.readInt32BE(4 * y);
            for (;y < 64; ++y) e[y] = p(e[y - 2]) + e[y - 7] + l(e[y - 15]) + e[y - 16] | 0;
            for (var g = 0; g < 64; ++g) {
                var _ = v + d(f) + c(f, s, b) + a[g] + e[g] | 0, m = h(r) + u(r, n, i) | 0;
                v = b, b = s, s = f, f = o + _ | 0, o = i, i = n, n = r, r = _ + m | 0;
            }
            this._a = r + this._a | 0, this._b = n + this._b | 0, this._c = i + this._c | 0, 
            this._d = o + this._d | 0, this._e = f + this._e | 0, this._f = s + this._f | 0, 
