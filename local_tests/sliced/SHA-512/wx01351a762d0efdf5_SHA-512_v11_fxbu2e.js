...
function(e, t, r) {
        ...
        n.inherits(m, y), e.exports = m, m.blockSize = 512, m.outSize = 256, m.hmacStrength = 192, 
        m.padLength = 64, m.prototype._update = function(e, t) {
            ...
            var i = this.h[0], o = this.h[1], y = this.h[2], g = this.h[3], m = this.h[4], v = this.h[5], A = this.h[6], w = this.h[7];
            for (a(this.k.length === r.length), n = 0; n < r.length; n++) {
                var _ = u(w, l(m), f(m, v, A), this.k[n], r[n]), E = s(h(i), d(i, o, y));
                w = A, A = v, v = m, m = s(g, _), g = y, y = o, o = i, i = s(_, E);
            }
            this.h[0] = s(this.h[0], i), this.h[1] = s(this.h[1], o), this.h[2] = s(this.h[2], y), 
            this.h[3] = s(this.h[3], g), this.h[4] = s(this.h[4], m), this.h[5] = s(this.h[5], v), 
            this.h[6] = s(this.h[6], A), this.h[7] = s(this.h[7], w);
