...
function(e, t, r) {
        ...
        n(c, i), c.prototype.init = function() {
            ...
            for (var t = this._w, r = 0 | this._a, n = 0 | this._b, i = 0 | this._c, o = 0 | this._d, s = 0 | this._e, c = 0 | this._f, b = 0 | this._g, y = 0 | this._h, g = 0; g < 16; ++g) t[g] = e.readInt32BE(4 * g);
            for (;g < 64; ++g) t[g] = p(t[g - 2]) + t[g - 7] + l(t[g - 15]) + t[g - 16] | 0;
            for (var m = 0; m < 64; ++m) {
                var v = y + h(s) + u(s, c, b) + a[m] + t[m] | 0, A = d(r) + f(r, n, i) | 0;
                y = b, b = c, c = s, s = o + v | 0, o = i, i = n, n = r, r = v + A | 0;
            }
            this._a = r + this._a | 0, this._b = n + this._b | 0, this._c = i + this._c | 0, 
            this._d = o + this._d | 0, this._e = s + this._e | 0, this._f = c + this._f | 0, 
            this._g = b + this._g | 0, this._h = y + this._h | 0;
