...
function(e, t, r) {
        ...
        n.inherits(y, g), e.exports = y, y.blockSize = 512, y.outSize = 256, y.hmacStrength = 192, 
        y.padLength = 64, y.prototype._update = function(e, t) {
            ...
            for (a(this.k.length === r.length), n = 0; n < r.length; n++) {
                var S = f(w, l(y), u(y, m, _), this.k[n], r[n]), E = s(d(i), h(i, o, g));
                w = _, _ = m, m = y, y = s(v, S), v = g, g = o, o = i, i = s(S, E);
            }
            this.h[0] = s(this.h[0], i), this.h[1] = s(this.h[1], o), this.h[2] = s(this.h[2], g), 
            this.h[3] = s(this.h[3], v), this.h[4] = s(this.h[4], y), this.h[5] = s(this.h[5], m), 
